...
export default {
  ...
  mounted() {
    this.chartOptions.series[0].data = this.Europe;
    this.chartOptions.series[1].data = this.Africa;
    this.chartOptions.series[2].data = this.Oceania;
    this.chartOptions.series[3].data = this.NorthAmerica;
    this.chartOptions.series[4].data = this.SouthAmerica;
    this.chartOptions.series[5].data = this.Asia;
